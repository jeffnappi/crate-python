...
class DatabaseCreation(BaseDatabaseCreation):
    ...
    def sql_create_model(self, model, style, known_models=set()):
        ...
        # CRATE TABLE PARAMS
        crate_table_params = []
        number_of_replicas = getattr(model.Crate, "number_of_replicas", None)
        clustered_by = getattr(model.Crate, "clustered_by", None)
        number_of_shards = getattr(model.Crate, "number_of_shards", None)
